<%@ Page Title="" Language="VB" MasterPageFile="~/PRISM.master" AutoEventWireup="false" CodeFile="EditContent.aspx.vb" Inherits="EditContent" MaintainScrollPositionOnPostback="true"%>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table>
        <tr>
            ...
            <td>
                <asp:TextBox ID="EDITtxtName" runat="server" Width="200px" MaxLength="100"></asp:TextBox></td>
        </tr>
        <tr>
            <td valign="top" align="right">Title Heading:</td>
            <td>
                <asp:TextBox ID="EDITtxtTitle" runat="server" Width="500px" MaxLength="100"></asp:TextBox></td>
        </tr>
        <tr>
            <td valign="top" align="right">Content Body:</td>
            <td>
                <CKEditor:CKEditorControl ID="EDITCKBody" BasePath="./ckeditor/" runat="server" ></CKEditor:CKEditorControl>
            </td>
        </tr>
        <tr>
            <td valign="top" align="right">Go Live Date:</td>
            <td>
                <asp:TextBox ID="EDITtxtLiveDate" runat="server" Width="100px" ></asp:TextBox>
                <asp:ImageButton ID="liveDtCalBtn" runat="server" ImageUrl="~/Images/Calendar.png" />
                <asp:CalendarExtender ID="liveDtCalExt" runat="server" Enabled="true" PopupButtonID="liveDtCalBtn" TargetControlID="EDITtxtLiveDate"></asp:CalendarExtender>
            </td>
        </tr>
        <tr>
            <td valign="top" align="right">Expiration Date:</td>
            <td>
                <asp:TextBox ID="EDITtxtExpDate" runat="server" Width="100px" ></asp:TextBox>
                <asp:ImageButton ID="expDtCalBtn" runat="server" ImageUrl="~/Images/Calendar.png" />
                <asp:CalendarExtender ID="expDtCalExt" runat="server" Enabled="true" PopupButtonID="expDtCalBtn" TargetControlID="EDITtxtExpDate"></asp:CalendarExtender>
                <br /><br />
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td colspan="2" style="text-align:right">
                <asp:Button ID="EDITbtnSave" runat="server" Text="Save Content" class="button black"/>&nbsp;&nbsp;
